...
export class InternalServerError extends BaseError {
  constructor(description: string = 'Internal Server Error') {
    super('InternalServerError', HttpStatusCode.INTERNAL_SERVER, description, true);
  }
}
...
export class NotImplementedError extends BaseError {
  constructor(description: string = 'Not Implemented') {
    super('NotImplementedError', HttpStatusCode.NOT_IMPLEMENTED, description, true);
  }
}
...
export class ServiceUnavailableError extends BaseError {
  constructor(description: string = 'Service Unavailable') {
    super('ServiceUnavailableError', HttpStatusCode.SERVICE_UNAVAILABLE, description, true);
  }
}
